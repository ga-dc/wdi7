...
| Date Assigned | Due Date | Assignment |
|---|---|---|
| Monday | Due Wednesday @0900 | [Hogwarts](https://github.com/ga-dc/hogwarts_rails) |
| Wednesday | Due Friday @0900 | Port [Landlord](https://github.com/ga-dc/landlord) to Rails and deploy it. |
